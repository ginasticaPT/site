    ...
    <div className="overview-page">
      ...
      <section className="year-grid" aria-label="Resumo anual de acontecimentos">
        <article className="year-card">
          <h2>2024</h2>
          <ul>
            <li>Em 15 Dezembro de 2024,  1.ª volta das eleições dos órgãos sociais da FGP,  na contagem dos votos <strong>foram declarados pelo Presidente da MAG</strong> e pela Comissão Eleitoral <strong>nulos 6 votos por correspondência por irregularidades</strong> e confirmou-se a necessidade de se realizar uma 2ªvolta.</li>
        ...
        <article className="year-card">
          <h2>2025</h2>
          <ul>
            <li>A 11 de janeiro a realização da 2.ª volta das eleições abrangeu apenas a eleição dos órgãos Conselho Fiscal e Conselho de Ajuizamento.</li>
