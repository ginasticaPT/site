...
function Timeline() {
  ...
  const events = [
    ...
    },
    {
      ...
      fact: [
        <p>No dia 24 de junho de 2026, as <strong>Associações de Ginástica do Centro e do Distrito de Leiria submetem uma ação judicial contra a FGP no TAFC, destinada a impugnar as deliberações tomadas pela Assembleia Geral de 23 de março de 2026</strong> que, por maioria expressiva, decidiu pela manutenção dos mandatos dos cinco delegados na AG</p>,
        ...
        <p>A ação assenta, nos seus fundamentos, na mesma posição que a própria FGP tem defendido perante o IPDJ. <strong>Ré e autoras convergem, assim, no objetivo de afastar os efeitos de uma deliberação tomada pela Assembleia Geral.</strong></p>,
        'A refletir:',
        {
          type: 'bullets',
          items: [
